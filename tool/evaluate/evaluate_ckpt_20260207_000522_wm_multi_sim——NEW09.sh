...
# This is the "New09" setting: controller_world_model_strength defaults to 0.9.
#
...
#   bash tool/evaluate/evaluate_ckpt_20260207_000522_wm_multi_sim——NEW09.sh
...
EXP_ROOT=${EXP_ROOT:-"eval/WoTE/ckpt_compare_20260207_wm/multi_simNew09"}
...
run_matrix_interleaved() {
  # 10 scenarios: tracker styles + post styles + noise stress.
