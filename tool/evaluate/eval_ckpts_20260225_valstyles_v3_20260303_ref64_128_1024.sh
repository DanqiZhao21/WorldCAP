...
# Eval script for 3 checkpoints trained with different controller bundle sizes (64/128/1024).
#
# Requirement:
# - Evaluate ATTN fusion only.
# - During eval, CTRL_REF/CTRL_EXEC must match the bundle size used in training.
...
# Checkpoints (placeholders; override via env when ckpts are ready)
CKPT_ATTN_CTRL64=${CKPT_ATTN_CTRL64:-"${ROOT}/trainingResult/ckpts_20260303_155602/epoch=38-step=51870.ckpt"}
CKPT_ATTN_CTRL128=${CKPT_ATTN_CTRL128:-"${ROOT}/trainingResult/ckpts_20260303_160133/epoch=38-step=51870.ckpt"}
CKPT_ATTN_CTRL1024=${CKPT_ATTN_CTRL1024:-"${ROOT}/trainingResult/ckpts_20260303_040613/epoch=39-step=53200.ckpt"}
...
OUT_ROOT=${OUT_ROOT:-"eval/WoTE/ckpt_20260303/attn_ref64_128new"}
...
main() {
  ...
  echo "============================================================"
  echo "[EVAL] attn-only (ref bank size ablation: 64/128/1024)"
