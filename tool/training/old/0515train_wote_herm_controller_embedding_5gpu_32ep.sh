...
# This mirrors 0514train_wote_herm_exec_only_5gpu_32ep.sh, except:
...
export CUDA_VISIBLE_DEVICES=${GPU_IDS:-0,1,2,3,4}
...
RUN_NAME=${RUN_NAME:-"wote_herm_controller_embedding_5gpu_32ep_${RUN_TS}"}
...
export WOTE_WANDB_TAGS=${WOTE_WANDB_TAGS:-wote,herm,controller-embedding,attn-film,5gpu,32ep}
...
"${PYTHON}" ./navsim/planning/script/run_training.py \
  ...
  split=trainval \
  experiment_name="WoTE/herm_controller_embedding/herm_controller_embedding_5gpu_32ep_${RUN_TS}" \
