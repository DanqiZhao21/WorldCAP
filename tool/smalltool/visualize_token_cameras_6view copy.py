...
Typical usage:
  python tool/smalltool/visualize_token_cameras_6view.py \
    ...
    --split val \
    --out-dir /home/zhaodanqi/clone/WoTE/pic/6camScenarios
...
def _save_cam6_mosaic(*, frame, out_path: Path) -> None:
    """Create a seamless 2x3 mosaic and save to disk."""
...
def main() -> int:
    ...
    out_path = out_dir / f"{token}_{ts}_cam6.png"
    ...
    _save_cam6_mosaic(frame=frame, out_path=out_path)
