...
#NOTE:改成多模态轨迹的可视化效果！！！
    ...
    def _compose_future_bev_targets_from_base(self, targets: Dict[str, torch.Tensor]):
        """
        Rebuild controller-specific future BEV semantic maps from cached base map using
        current `exec_trajs_buffer` and cached indices + frame interval. No-op if already present.
